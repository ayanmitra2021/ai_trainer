...
<!-- 👤 HUMAN-IN-THE-LOOP: This prompt is a working draft. Ayan should review
     ...
     section) before this agent is trusted at scale. See docs/human-in-the-loop.md. -->
...
1. **Questionnaire answers** — four short answers about the practitioner's background, role, and goals.
...
## The four questions and what they signal
...
3. Rank remaining candidates by how well `focus_area` and `experience_level` match the certification's `typical_audience`, `focus_area`, and `level`.
